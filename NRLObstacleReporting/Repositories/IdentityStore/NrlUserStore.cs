    ...
    IQueryableUserStore<IdentityUser>
{
    ...
    /// <summary>
    /// Implementation of IqueryableUserStore.Users
    /// </summary>
    /// <returns></returns>
    private IQueryable<IdentityUser> GetUsers()
    {
        ...
        return conn.Query<IdentityUser>(sql).AsQueryable();
    }

    /// <inheritdoc/>
    IQueryable<IdentityUser> IQueryableUserStore<IdentityUser>.Users => GetUsers();
