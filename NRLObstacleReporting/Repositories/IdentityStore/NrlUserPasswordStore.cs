...
// Dapper-based implementation of IUserPasswordStore without EF Core
public class NrlUserPasswordStore : IUserPasswordStore<IdentityUser>
{
    private readonly string _connectionString;
    private const string UsersTable = "AspNetUsers"; // default Identity users table

    public NrlUserPasswordStore()
    {
